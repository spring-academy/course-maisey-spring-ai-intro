...
{{< note >}}
The hands-on labs use a mock service by default, so you won't incur API costs while learning.
{{< /note >}}

## Adapting Foundation Models

Instead of training models from scratch (expensive!), we adapt existing models using three techniques you'll apply in the labs:
...
- Model decides when to use tools based on the user's intent
