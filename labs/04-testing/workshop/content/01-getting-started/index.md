...
In this lab you will write automated tests for the support assistant. 

Code that calls an LLM cannot be tested like normal code. The model rewords answers, picks different synonyms, and sometimes refuses to answer at all. 

Two patterns get you most of the way there.
